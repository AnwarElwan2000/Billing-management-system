...
@section('content')
    ...
    @if (session()->has('edit_invoices'))
        <script>
            window.onload = function() {
                notif({
                    msg: "تم تعديل الفاتورة بنجاج",
                    type: 'success'
                })
            }
        </script>
                    ...
                    <form action="{{ route('Invoices.update', $invoice->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" value="{{ $invoice->invoice_Date }}"
                                    name="invoice_Date" placeholder="YYYY-MM-DD" type="date" value="" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" value="{{ $invoice->Discount }}" class="form-control form-control-lg"
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="{{ $invoice->Rate_VAT }}">حدد نسبة الضريبة</option>
                        ...
                        <div class="d-flex justify-content-center">
                            <input type="submit" class="btn btn-primary" name="send" value="حفظ البيانات">
                        </div>
