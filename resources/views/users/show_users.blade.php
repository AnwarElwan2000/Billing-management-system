...
@if (session()->has('upload_file_success'))
<script>
                    ...
                    <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                @can('اضافة صورة شخصية owner')
                                    <th class="wd-15p border-bottom-0">Upload Img</th>
                                @endcan
                        ...
                        <tbody>
                            @foreach ($data as $key => $user)
                                <tr>
                                    ...
                                    @can('اضافة صورة شخصية owner')
                                        <td>
                                            <form action="{{url('upload_file_owner')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="id" value="{{$user->id}}">
                                                <input type="file" required name="upload_file_owner"
                                                    class="btn btn-outline-primary btn-sm form-control">
                                                    <input type="submit" class="btn btn-outline-success btn-sm mt-1" value="Upload" name="upload">
