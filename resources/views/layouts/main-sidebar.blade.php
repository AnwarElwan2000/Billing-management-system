...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'index')) }}"><img
                src="{{ URL::asset('assets/img/brand/untitled-1_80.png') }}" class="main-logo" alt="logo"></a>
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                         ...
                         @foreach (Auth::User()->roles_name as $roles)
                             @if (Auth::User()->upload_img !== null && $roles == "user")
                             <img src="{{asset('user_img/' . Auth::User()->upload_img )}}" alt="user-img"
                             class="avatar avatar-xl brround">
                           <span class="avatar-status profile-status bg-green"></span>
 
                             @elseif(Auth::User()->upload_img !== null && $roles == "owner")
                             <img src="{{asset('owner_img/' . Auth::User()->upload_img )}}" alt="user-img"
                             class="avatar avatar-xl brround">
                           <span class="avatar-status profile-status bg-green"></span>
                             @else
                             <img src="{{ URL::asset('assets/img/faces/1.jpg') }}" alt="user-img"
                             class="avatar avatar-xl brround">
                           <span class="avatar-status profile-status bg-green"></span>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Unpaid_bills')) }}">الفواتير الغير
                                    مدفوعة</a>
                            </li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Partially_paid_bills')) }}">الفواتير
                                    المدفوعة
                                    جزئيا</a></li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoice_Archives')) }}">ارشفة الفواتير</a>
                            </li>
                        @endcan
                    </ul>
                </li>
