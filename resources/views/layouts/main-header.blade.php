                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            ...
                            <h3 id="notification_count" class="text-light">
                    ...
                    <a class="profile-user d-flex" href="">
                        @foreach (Auth::User()->roles_name as $roles)
                            @if (Auth::User()->upload_img !== null && $roles == 'user')
                                <img alt="" src="{{ asset('user_img/' . Auth::User()->upload_img) }}">
                            @elseif(Auth::User()->upload_img !== null && $roles == 'owner')
                                <img alt="" src="{{ asset('owner_img/' . Auth::User()->upload_img) }}">
                            @else
                                <img alt="" src="{{ URL::asset('assets/img/faces/1.jpg') }}">
                            @endif
                        @endforeach
                    </a>
                            ...
                            <div class="d-flex wd-100p">
                                <div class="main-img-user">
                                    ...
                                    @foreach (Auth::User()->roles_name as $roles)
                                        @if (Auth::User()->upload_img !== null && $roles == 'user')
                                            <img alt=""
                                                src="{{ asset('user_img/' . Auth::User()->upload_img) }}"
                                                class="">
